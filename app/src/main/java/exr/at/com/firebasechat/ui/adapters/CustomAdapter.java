...
//import com.example.mailf.chatbotapp.R;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(view == null)
        {
            if(list_chat_models.get(position).isSend)
                view = layoutInflater.inflate(R.layout.list_robot_message_send,null);
            else
                view = layoutInflater.inflate(R.layout.list_robot_message_recv,null);
